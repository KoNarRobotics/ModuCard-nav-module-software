...
HAL_StatusTypeDef W25Q128_OCTO_SPI_Init(QSPI_HandleTypeDef* hospi);
HAL_StatusTypeDef W25Q128_OSPI_ResetChip(QSPI_HandleTypeDef* hospi);
HAL_StatusTypeDef W25Q128_OSPI_Configuration(QSPI_HandleTypeDef* hospi);
HAL_StatusTypeDef W25Q128_OSPI_WriteEnable(QSPI_HandleTypeDef* hospi);
HAL_StatusTypeDef W25Q128_OSPI_WriteDisable(QSPI_HandleTypeDef* hospi);
HAL_StatusTypeDef W25Q128_OSPI_AutoPollingMemReady(QSPI_HandleTypeDef* hospi);
HAL_StatusTypeDef W25Q128_OSPI_Erase_Chip(QSPI_HandleTypeDef* hospi);
HAL_StatusTypeDef W25Q128_OSPI_EraseSector(QSPI_HandleTypeDef* hospi, uint32_t EraseStartAddress, uint32_t EraseEndAddress);
HAL_StatusTypeDef W25Q128_OSPI_Erase_Block_32KB(QSPI_HandleTypeDef* hospi, uint32_t BlockAddress);
HAL_StatusTypeDef W25Q128_OSPI_Erase_Block_64KB(QSPI_HandleTypeDef* hospi, uint32_t BlockAddress);
HAL_StatusTypeDef W25Q128_OSPI_Write(QSPI_HandleTypeDef* hospi, uint8_t* pData, uint32_t WriteAddr, uint32_t Size);
HAL_StatusTypeDef W25Q128_OSPI_Read(QSPI_HandleTypeDef* hospi, uint8_t* pData, uint32_t ReadAddr, uint32_t Size);
HAL_StatusTypeDef W25Q128_OSPI_EnableMemoryMappedMode(QSPI_HandleTypeDef* hospi);
HAL_StatusTypeDef W25Q128_IsBusy(QSPI_HandleTypeDef* hospi);
HAL_StatusTypeDef W25Q128_Read_Status_Registers(QSPI_HandleTypeDef* hospi, uint8_t* register_data, uint8_t register_num);
HAL_StatusTypeDef W25Q128_Write_Status_Registers(QSPI_HandleTypeDef* hospi, uint8_t reg_data, uint8_t reg_num);
