...
#define USBD_PID                      0x6969  /* Replace '0xaaaa' with your device product ID */
#define USBD_LANGID_STRING            0x409   /* Replace '0xbbb' with your device language ID */
#define USBD_MANUFACTURER_STRING      "KoNaR" /* Add your manufacturer string */
#define USBD_PRODUCT_HS_STRING        "ModuCard_CDC in HS mode" /* Add your product High Speed string */
#define USBD_PRODUCT_FS_STRING        "ModuCard_CDC in FS mode" /* Add your product Full Speed string */
#define USBD_CONFIGURATION_HS_STRING  "ModuCard usb" /* Add your configuration High Speed string */
#define USBD_INTERFACE_HS_STRING      "ModuCard usb" /* Add your Interface High Speed string */
#define USBD_CONFIGURATION_FS_STRING  "ModuCard usb" /* Add your configuration Full Speed string */
#define USBD_INTERFACE_FS_STRING      "ModuCard usb" /* Add your Interface Full Speed string */
